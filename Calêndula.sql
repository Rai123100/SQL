...
INSERT INTO Medico (MedicoID, CRM, CPF, RG, Nome, Email, Nascimento, Genero, Celular, CEP, Endereco)
VALUES
    (1, '11111111', '111.111.111-1', '11.111.112-1', 'Dr. Otto Octavius', 'otto@gmail.com', '14/06/1997', 'M', '55 (11) 11111-1111', '11111-111', 'Rua Ameixa, 617'),
    (2, '22222222', '111.111.111-2', '11.111.112-2', 'Dra. Deolane Silva', 'deolane@gmail.com', '17/09/1998', 'F', '55 (11) 11111-1112', '22222-222', 'Rua Ameixa, 618'),
    (3, '11111111', '111.111.111-3', '11.111.112-3', 'Dra. Raquel Ruy Barbosa', 'raquel@gmail.com', '24/10/2000', 'F', '55 (11) 11111-1113', '33333-333', 'Rua Ameixa, 619');
...
INSERT INTO Consulta (ConsultaID, NumerodaConsulta, DataConsulta, MedicoID, EspecialidadeID, ClienteID)
VALUES 
	(1,101,'2024-24-08',3,6,1),
	(2,102,'2024-10-08',1,4,2),
	(3,103,'2024-25-08',3,3,3),
	(4,104,'2024-10-09',2,2,2),
	(5,105,'2024-13-09',2,1,1),
	(6,106,'2024-12-08',1,7,3);
...
INSERT INTO Cliente (ClienteID, CPF, Nome, Email, RG, Nascimento, Genero, Endereco, Telefone)
VALUES
